...
_G.packer_plugins = {
  ...
  ["nvim-web-devicons"] = {
    loaded = false,
    needs_bufread = false,
    path = "/Users/max/.local/share/nvim/site/pack/packer/opt/nvim-web-devicons",
  ...
  ["sidebar.nvim"] = {
    loaded = true,
    path = "/Users/max/.local/share/nvim/site/pack/packer/start/sidebar.nvim",
  ...
  ["vim-be-good"] = {
    loaded = true,
    path = "/Users/max/.local/share/nvim/site/pack/packer/start/vim-be-good",
